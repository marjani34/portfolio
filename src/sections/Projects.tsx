        ...
        <div className="relative h-64 overflow-hidden">
          ...
          {projectImageList.length > 1 && (
            <button
              ...
              className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-white/30"
            >
              View Gallery
            </button>
          )}
